...
class TestDeleteAgentsSuccess(unittest.TestCase):
  ...
  def test_delete_one_agent_with_valid_id(self):
    """delete_agents should succeed when given an valid `id`.
    ...
    resp = self.client.delete_agents(payload)
  ...
  def test_delete_multiple_agents_with_valid_id(self):
    """delete_agents should succeed when given multiple valid `id`s.
...
class TestDeleteAgentsFailure(unittest.TestCase):
  ...
  def test_delete_multiple_agents_with_invalid_id(self):
    """delete_agents should fail when given multiple invalid `id`s.
...
class TestDeleteBulkAgentsSomeFailure(unittest.TestCase):
  ...
  def test_delete_some_agents_with_invalid_id(self):
    """delete_agents should succeed when given some invalid `id`s and some valid.
